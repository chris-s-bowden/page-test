...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block1"> Show/Hide Example </button>  
  ...
  \
  In the majority of years, the majority of the crop's water needs are fully met by rainfall and irrigation is generally minimal. In some years with lower than average rainfall (e.g., 1999, 2007, 2012), a larger amount of irrigation is required to meet the maize crop's water demands. However, even in these years, the amount of irrigation water used is still less than the amount of water provided by rainfall during the growing season.
...
Now looking at the 'rainfed vs irrigated yield' plot, do you think that rainfall in Richmond in the eastern corn belt is generally sufficient to meet the water requirements of maize in the majority of years?
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block2"> Show/Hide Example </button>  
  ...
  Generally, rainfall is sufficient for maize's water demands in Richmond, Indiana. This can be seen by the similar levels of yield acheived for both rainfed and irrigated maize production in most years, along with the stability of rainfed yields across years. The largest yield gains from irrigation are typically found in years with lowest rainfall (e.g., 1999, 2007, 2012), but there are also small yield gains from irrigation in other years (e.g., 1991). These reflect years where relatively small amounts of supplemental irrigation play an important role in buffering crops against dry spells within the growing season, which can occur even when total seasonal rainfall is sufficient to meet crop needs. 
...
Using the 'total rainfed and irrigation' plot, how does the amount of rainfall and irrigation water use vary across the 30-year (1991-2020) simulation period? What differences do you notice between this plot and the plot from the eastern corn belt in the first part of the exercise?
...
How does the amount and variability of seasonal rainfall differ in the site in southwestern Nebraska compared to that of the sites in central California and Indiana?   
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#Block5"> Show/Hide Example </button>  
  ...
  The sites in California (dry) and Indiana (wet) represented sites with consistently low or high annual rainfall patterns. In contrast, seasonal rainfall at the Nebraska site shows greater inter-annual variation, with some years receive similar levels of rainfall to the site in Indiana but other years receive very little rainfall during the growing season. 

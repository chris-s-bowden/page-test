...
<button class="btn1 btn1-primary1" data-toggle="collapse" data-target="#Block1"> Show/Hide Example </button>  
...
<button class="btn2 btn2-primary2" data-toggle="collapse" data-target="#Block2"> Show/Hide Example </button>  

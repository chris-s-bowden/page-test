...
<button1 class="btn1 btn1-primary1" data-toggle="collapse" data-target="#Block1"> Show/Hide Example </button1>  
...
<button2 class="btn2 btn2-primary2" data-toggle="collapse" data-target="#Block2"> Show/Hide Example </button2>  
...
<button class="btn3 btn3-primary3" data-toggle="collapse" data-target="#Block3"> Show/Hide Example </button>  
